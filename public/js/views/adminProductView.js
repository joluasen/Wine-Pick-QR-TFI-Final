// public/js/views/adminProductView.js
import { escapeHtml, calculatePromoPrice, formatDate } from '../core/utils.js';

/**
 * Renderiza la ficha de producto igual a la pública, pero con botón Editar para admin
 * @param {Object} product
 * @param {Function} onEdit
 * @returns {string}
 */
export function renderAdminProductView(product, onEdit) {
